<main class="container-fluid eco-main py-5 text-white">
    <div class="container-fluid">
        ...
        <div class="image-collage d-none d-lg-flex position-relative justify-content-center mb-5">
            <img src="../public/assets/images/img1.png" class="img1 position-absolute rounded shadow" alt="img1">
            <img src="../public/assets/images/img2.png" class="img2 position-absolute rounded shadow" alt="img2">
            <img src="../public/assets/images/img3.png" class="img3 position-absolute rounded shadow" alt="img3">
        </div>
