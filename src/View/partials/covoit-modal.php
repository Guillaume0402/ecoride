    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content auth-modal-content">
            ...
            <form class="auth-form p-0 p-lg-5" action="/covoiturages/create" method="POST">
                ...
                <div class="mb-3">
                    <label class="form-label" for="covoit_ville_depart">Ville de départ</label>
                    <input
                        type="text"
                        class="form-control"
                        id="covoit_ville_depart"
                        name="ville_depart"
                ...
                <div class="mb-3">
                    <label class="form-label" for="covoit_ville_arrivee">Ville d'arrivée</label>
                    <input
                        type="text"
                        class="form-control"
                        id="covoit_ville_arrivee"
                        name="ville_arrivee"
                        placeholder="Ex : Lyon"
                        required>
                </div>
                ...
                <div class="mb-3">
                    <label class="form-label" for="covoit_prix">Prix du trajet</label>
                    <input
                        type="number"
                        class="form-control"
                        id="covoit_prix"
                ...
                <div class="mb-3">
                    <label class="form-label" for="vehicleSelect">Choix du véhicule</label>
                    ...
                    <?php if (!empty($userVehicles)): ?>
                        <select class="form-select" name="vehicle_id" id="vehicleSelect" required>
                            ...
                            <?php foreach ($userVehicles as $veh): ?>
                                <option
                                    value="<?= htmlspecialchars((string)$veh->getId(), ENT_QUOTES, 'UTF-8') ?>"
                                    data-places="<?= (int)$veh->getPlacesDispo() ?>">
                    ...
                    <?php else: ?>
                        <div class="alert alert-warning" role="alert">
                            ...
                            <a class="alert-link" href="/vehicle/create">Ajouter un véhicule</a>
                        </div>
                        <select class="form-select" id="vehicleSelect" disabled>
                ...
                <?php if (!empty($userVehicles)): ?>
                    <div class="mb-3">
                        <label class="form-label" for="placesInput">Places disponibles pour ce trajet</label>
                        <input
                            type="number"
                            class="form-control"
                            name="places"
                        ...
                        <small id="placesHelp" class="form-text">Limité au nombre de places du véhicule sélectionné.</small>
                    </div>
                <?php endif; ?>

                <div class="mb-3">
                    <label class="form-label" for="covoit_date">Date du départ</label>
                    <input
                        type="date"
                        class="form-control"
                        id="covoit_date"
                ...
                <div class="mb-3">
                    <label class="form-label" for="covoit_time">Heure du départ</label>
                    <input
                        type="time"
                        class="form-control"
                        id="covoit_time"
                ...
                <div class="mb-3">
                    <label class="form-label" for="covoit_time_arrivee">Heure d'arrivée</label>
                    <input
                        type="time"
                        class="form-control"
                        id="covoit_time_arrivee"
                        name="time_arrivee"
                        required
                        aria-describedby="arriveeHelp">
                    <small id="arriveeHelp" class="form-text d-block mt-1"></small>
                </div>

                <div class="text-center">
                    <button type="submit" class="btn btn-inscription" <?= empty($userVehicles) ? 'disabled' : '' ?>>
                        Créer le voyage
                    </button>
                </div>
            </form>
            ...
            <?php if (!empty($userVehicles)): ?>
                <script>
                    (function() {
                        ...
                        timeArrInput?.addEventListener('change', syncTimeMin);
