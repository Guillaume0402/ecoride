<footer class="mt-auto d-flex flex-column flex-lg-row justify-content-center align-items-center gap-2 gap-lg-5 py-3  w-100 ">
    ...
    <a class="mb-0" href="/mentions-legales" rel="noopener" aria-label="Mentions légales">Mentions légales</a>
    <a class="mb-0" href="/terms" rel="noopener" aria-label="Conditions d'utilisation (CGU)">CGU</a>
