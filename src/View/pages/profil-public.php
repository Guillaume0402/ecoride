...
<div class="container-fluid py-5 my-profil-page profil-public-page">
    <div class="card shadow-lg border-0 rounded-4 p-4 mb-5 header-card">
        <div class="row g-3 g-lg-0 align-items-start profil-public-header">
            <div class="col-12 col-md-5 col-lg-6 text-center text-md-start mb-2 mb-lg-0 d-flex">
                <div class="left-stack d-flex flex-column align-items-center align-items-md-start gap-2 w-100">
                    ...
                    <h2 class="fw-bold mb-2" style="word-break:normal;overflow-wrap:normal;max-width:100%;">
                    ...
                    <ul class="list-unstyled small mb-3">
                        ...
                        foreach ($prefsOut as $label) {
                            echo '<li>' . htmlspecialchars($label) . '</li>';
                        }
                        ?>
                    </ul>
                    <div class="d-flex flex-md-row gap-2 history-cta mt-3 mt-md-auto align-self-md-start">
